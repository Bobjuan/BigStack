-- Create player_stats table with comprehensive poker statistics
CREATE TABLE IF NOT EXISTS player_stats (
    ...
    total_bb_won INTEGER DEFAULT 0,
    total_pot_size_won INTEGER DEFAULT 0,
    
    -- Pre-flop stats
    vpip_opportunities INTEGER DEFAULT 0,
    vpip_actions INTEGER DEFAULT 0,
    pfr_opportunities INTEGER DEFAULT 0,
    pfr_actions INTEGER DEFAULT 0,
    btn_rfi_opportunities INTEGER DEFAULT 0,
    btn_rfi_actions INTEGER DEFAULT 0,
    threeb_opportunities INTEGER DEFAULT 0,
    threeb_actions INTEGER DEFAULT 0,
    fold_vs_3bet_opportunities INTEGER DEFAULT 0,
    fold_vs_3bet_actions INTEGER DEFAULT 0,
    fourbet_opportunities INTEGER DEFAULT 0,
    fourbet_actions INTEGER DEFAULT 0,
    fold_vs_4bet_opportunities INTEGER DEFAULT 0,
    fold_vs_4bet_actions INTEGER DEFAULT 0,
    
    -- Post-flop aggression
    agg_bets INTEGER DEFAULT 0,
    agg_raises INTEGER DEFAULT 0,
    agg_calls INTEGER DEFAULT 0,
    
    -- C-betting
    cbet_flop_opportunities INTEGER DEFAULT 0,
    cbet_flop_actions INTEGER DEFAULT 0,
    fold_vs_cbet_flop_opportunities INTEGER DEFAULT 0,
    fold_vs_cbet_flop_actions INTEGER DEFAULT 0,
    raise_vs_cbet_flop_opportunities INTEGER DEFAULT 0,
    raise_vs_cbet_flop_actions INTEGER DEFAULT 0,
    
    -- Other post-flop
    ch_raise_flop_opportunities INTEGER DEFAULT 0,
    ch_raise_flop_actions INTEGER DEFAULT 0,
    donk_flop_opportunities INTEGER DEFAULT 0,
    donk_flop_actions INTEGER DEFAULT 0,
    
    -- Showdown
    wtsd_opportunities INTEGER DEFAULT 0,
    wtsd_actions INTEGER DEFAULT 0,
    wsd_opportunities INTEGER DEFAULT 0,
    wsd_actions INTEGER DEFAULT 0,
    wwsf_opportunities INTEGER DEFAULT 0,
    wwsf_actions INTEGER DEFAULT 0,
    
    -- Position-specific VPIP stats
    btn_vpip_opportunities INTEGER DEFAULT 0,
    btn_vpip_actions INTEGER DEFAULT 0,
    sb_vpip_opportunities INTEGER DEFAULT 0,
    sb_vpip_actions INTEGER DEFAULT 0,
    bb_vpip_opportunities INTEGER DEFAULT 0,
    bb_vpip_actions INTEGER DEFAULT 0,
    btn_sb_vpip_opportunities INTEGER DEFAULT 0,
    btn_sb_vpip_actions INTEGER DEFAULT 0,
    utg_vpip_opportunities INTEGER DEFAULT 0,
    utg_vpip_actions INTEGER DEFAULT 0,
    utg1_vpip_opportunities INTEGER DEFAULT 0,
    utg1_vpip_actions INTEGER DEFAULT 0,
    mp_vpip_opportunities INTEGER DEFAULT 0,
    mp_vpip_actions INTEGER DEFAULT 0,
    lj_vpip_opportunities INTEGER DEFAULT 0,
    lj_vpip_actions INTEGER DEFAULT 0,
    hj_vpip_opportunities INTEGER DEFAULT 0,
    hj_vpip_actions INTEGER DEFAULT 0,
    co_vpip_opportunities INTEGER DEFAULT 0,
    co_vpip_actions INTEGER DEFAULT 0,
    
    -- Position-specific PFR stats
    btn_pfr_opportunities INTEGER DEFAULT 0,
    btn_pfr_actions INTEGER DEFAULT 0,
    sb_pfr_opportunities INTEGER DEFAULT 0,
    sb_pfr_actions INTEGER DEFAULT 0,
    bb_pfr_opportunities INTEGER DEFAULT 0,
    bb_pfr_actions INTEGER DEFAULT 0,
    btn_sb_pfr_opportunities INTEGER DEFAULT 0,
    btn_sb_pfr_actions INTEGER DEFAULT 0,
    utg_pfr_opportunities INTEGER DEFAULT 0,
    utg_pfr_actions INTEGER DEFAULT 0,
    utg1_pfr_opportunities INTEGER DEFAULT 0,
    utg1_pfr_actions INTEGER DEFAULT 0,
    mp_pfr_opportunities INTEGER DEFAULT 0,
    mp_pfr_actions INTEGER DEFAULT 0,
    lj_pfr_opportunities INTEGER DEFAULT 0,
    lj_pfr_actions INTEGER DEFAULT 0,
    hj_pfr_opportunities INTEGER DEFAULT 0,
    hj_pfr_actions INTEGER DEFAULT 0,
    co_pfr_opportunities INTEGER DEFAULT 0,
    co_pfr_actions INTEGER DEFAULT 0,
...
-- Create or replace the batch_update_player_stats RPC function with UPSERT logic
