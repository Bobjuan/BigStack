    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-30">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-400">Continue your poker journey</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M5.4635 14.3003C5.23003 13.5681 5.09865 12.7862 5.09865 12C5.09865 11.2138 5.23003 10.4319 5.4635 9.69977V6.60889H1.45667C0.530324 8.22586 0 10.0682 0 12C0 13.9318 0.530324 15.7741 1.45667 17.3912L5.4635 14.3003Z" fill="#FBBC05"/>
        ...
        <p className="mt-8 text-center text-gray-400">
          ...
          <Link to="/signup" className="text-white font-medium hover:text-gray-300 transition-colors duration-150">
            Sign up
          </Link>
        </p>
      </div>
